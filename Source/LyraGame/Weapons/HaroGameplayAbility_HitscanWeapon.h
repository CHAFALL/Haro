...
#include "HaroGameplayAbility_HitscanWeapon.generated.h"
 ...
 */
UCLASS()
class LYRAGAME_API UHaroGameplayAbility_HitscanWeapon : public UHaroGameplayAbility_WeaponBase
{
	GENERATED_BODY()
	
public:
	UHaroGameplayAbility_HitscanWeapon(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
protected:
	struct FHitscanWeaponFiringInput
	{
		...
		UHaroRangedWeaponInstance* WeaponData = nullptr;
...
protected:
	...
	void StartHitscanWeaponTargeting();

	// Called when target data is ready
	UFUNCTION(BlueprintImplementableEvent)
	void OnHitscanWeaponTargetDataReady(const FGameplayAbilityTargetDataHandle& TargetData);
