...
#include "HaroHitMarkerConfirmationWidget.generated.h"

class SHaroHitMarkerConfirmationWidget;
class SWidget;
class UObject;
struct FGameplayTag;

UCLASS()
class UHaroHitMarkerConfirmationWidget : public UWidget
{
	GENERATED_BODY()

public:
	UHaroHitMarkerConfirmationWidget(const FObjectInitializer& ObjectInitializer);
...
private:
	...
	TSharedPtr<SHaroHitMarkerConfirmationWidget> MyMarkerWidget;
};
