...
#include "HaroReticleWidgetBase.h"

#include "Inventory/LyraInventoryItemInstance.h"
#include "Weapons/HaroRangedWeaponInstance.h"
#include "Weapons/LyraWeaponInstance.h"

UHaroReticleWidgetBase::UHaroReticleWidgetBase(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
}

void UHaroReticleWidgetBase::InitializeFromWeapon(ULyraWeaponInstance* InWeapon)
{
...
float UHaroReticleWidgetBase::ComputeSpreadAngle() const
{
	if (const UHaroRangedWeaponInstance* RangedWeapon = Cast<const UHaroRangedWeaponInstance>(WeaponInstance))
	{
...
bool UHaroReticleWidgetBase::HasFirstShotAccuracy() const
{
	if (const UHaroRangedWeaponInstance* RangedWeapon = Cast<const UHaroRangedWeaponInstance>(WeaponInstance))
	{
...
float UHaroReticleWidgetBase::ComputeMaxScreenspaceSpreadRadius() const
{
